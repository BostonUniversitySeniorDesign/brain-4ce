...
def create_epochs(subject, cases):
    #Load data
    files = eegbci.load_data(subject, cases, 'C:\\Users\\shortallb\\Documents\\brain-4ce\\PCA\\Data')
...
# Uncomment if labeled 2D data is needed
...
df.to_csv('C:\\Users\\shortallb\\Documents\\brain-4ce\\PCA\\Data\\data2D.csv')

#Uncomment if 2D labels are needed

# df = pd.DataFrame(labels_2D)
# df.to_csv('C:\\Users\\shortallb\\Documents\\brain-4ce\\PCA\\Data\\labels2D.csv')
